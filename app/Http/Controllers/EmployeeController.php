...
class EmployeeController extends Controller
{
    ...
    private function resolveColumnValue($row, string $key): string
    {
        return match ($key) {
            ...
            'tgl_pm'         => e($row->profile->join_date ? date('d', strtotime($row->profile->join_date)) : '-'),
            'bln_pem'        => e($row->profile->join_date ? date('m', strtotime($row->profile->join_date)) : '-'),
            'thn_pem'        => e($row->profile->join_date ? date('Y', strtotime($row->profile->join_date)) : '-'),
