<div class="modal fade bs-example-modal-l" id="componentModal-{{ $payroll->id }}" tabindex="-1"
    aria-labelledby="componentModal-{{ $payroll->id }}" aria-hidden="true">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <select name="bpjs_base_type" id="bpjs_base-{{ $payroll->id }}" class="form-control"
                                    data-bpjs-base data-context="detail" data-payroll-id="{{ $payroll->id }}">
                                    <option value="amount_salary"
                                        {{ $payroll->bpjs_base_type == 'amount_salary' ? 'selected' : '' }}>
                                        Gaji Pokok (amount_salary)
                                    </option>
                                    <option value="salary_allowance"
                                        {{ $payroll->bpjs_base_type == 'salary_allowance' ? 'selected' : '' }}>
                                        Gaji Pokok + Allowance Bulanan (salary_allowance)
                                    </option>
                                    <option value="base_budget"
                                        {{ $payroll->bpjs_base_type == 'base_budget' ? 'selected' : '' }}>
                            ...
                            <!-- BPJS Budget Fields -->
                            <div id="bpjs-budget-fields-{{ $payroll->id }}"
                                class="{{ $payroll->bpjs_base_type == 'base_budget' ? '' : 'd-none' }}">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="bpjs_budget_tk-{{ $payroll->id }}">BPJS Budget TK</label>
                                        <input type="text" class="form-control" name="bpjs_budget_tk"
                                            id="bpjs_budget_tk-{{ $payroll->id }}"
                                            value="{{ $payroll->bpjs_budget_tk ?? '' }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="bpjs_budget_kes-{{ $payroll->id }}">BPJS Budget KES</label>
                                        <input type="text" class="form-control" name="bpjs_budget_kes"
                                            id="bpjs_budget_kes-{{ $payroll->id }}"
                                            value="{{ $payroll->bpjs_budget_kes ?? '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div id="bpjs-normatif-fields-{{ $payroll->id }}"
                                class="{{ $payroll->bpjs_type == 'normatif' ? '' : 'd-none' }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bpjs_normatif[]"
                                                id="bpjs-jkk-{{ $payroll->id }}" value="jkk"
                                                {{ $payroll->jkk_company > 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bpjs_normatif[]"
                                                id="bpjs-jkm-{{ $payroll->id }}" value="jkm"
                                                {{ $payroll->jkm_company > 0 ? 'checked' : '' }}>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bpjs_normatif[]"
                                                id="bpjs-jht-{{ $payroll->id }}" value="jht"
                                                {{ $payroll->jht_company > 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bpjs_normatif[]"
                                                id="bpjs-jp-{{ $payroll->id }}" value="jp"
                                                {{ $payroll->jp_company > 0 ? 'checked' : '' }}>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bpjs_normatif[]"
                                                id="bpjs-kes-{{ $payroll->id }}" value="kes"
                                                {{ $payroll->kes_company > 0 ? 'checked' : '' }}>
                            ...
                            <div id="bpjs-unnormatif-fields-{{ $payroll->id }}"
                                class="{{ $payroll->bpjs_type == 'unnormatif' ? '' : 'd-none' }}">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="time_deductions[late]"
                                        id="time_deduction_late-{{ $payroll->id }}" class="form-control"
                                        placeholder="Masukkan jumlah potongan"
                                        value="{{ $timeDeductionsData[$payroll->id]['late'] ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="time_deduction_alpha-{{ $payroll->id }}">Potongan Alpha (Tidak
                                        Hadir)</label>
                                    <input type="text" name="time_deductions[alpha]"
                                        id="time_deduction_alpha-{{ $payroll->id }}" class="form-control"
                                        placeholder="Masukkan jumlah potongan"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="time_deductions[permit]"
                                        id="time_deduction_permit-{{ $payroll->id }}" class="form-control"
                                        placeholder="Masukkan jumlah potongan"
                                        value="{{ $timeDeductionsData[$payroll->id]['permit'] ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="time_deduction_leave-{{ $payroll->id }}">Potongan Cuti</label>
                                    <input type="text" name="time_deductions[leave]"
                                        id="time_deduction_leave-{{ $payroll->id }}" class="form-control"
                                        placeholder="Masukkan jumlah potongan"
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select name="overtime[pay_type]" id="overtime_pay_type-{{ $payroll->id }}"
                                        class="form-control">
                                        <option value="hourly"
                                            {{ isset($payroll->payroll_overtime->pay_type) && $payroll->payroll_overtime->pay_type == 'hourly' ? 'selected' : '' }}>
                                            Per Jam</option>
                                        <option value="daily"
                                            {{ isset($payroll->payroll_overtime->pay_type) && $payroll->payroll_overtime->pay_type == 'daily' ? 'selected' : '' }}>
                                            Per Hari</option>
                                    </select>
                                </div>
                                <div class="col-md-8">
                                    <label for="overtime_amount-{{ $payroll->id }}">Jumlah Lembur</label>
                                    <input type="text" name="overtime[amount]"
                                        id="overtime_amount-{{ $payroll->id }}" class="form-control"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pph21_method"
                                            value="ter_gross"
                                            {{ $payroll->pph21_method == 'ter_gross' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pph21_method"
                                            value="ter_gross_up"
                                            {{ $payroll->pph21_method == 'ter_gross_up' ? 'checked' : '' }}>
