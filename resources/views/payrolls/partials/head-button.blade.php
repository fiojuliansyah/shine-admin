<div class="btn-toolbar p-3" role="toolbar">
    <div class="btn-group me-2 mb-2 mb-sm-0">
        <form action=""></form>
        <button type="button" class="btn btn-primary waves-light waves-effect" data-bs-toggle="modal"
    ...
    <div class="btn-group me-2 mb-2 mb-sm-0">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#bulkUpdateModal">Bulk
                Update</a>
        </div>
    </div>
    <div class="btn-group me-2 mb-2 mb-sm-0">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#allowanceModal">+
                Tunjangan</a>
            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deductionModal">+
                Pengurangan lainnya</a>
        </div>
    </div>
</div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3" id="salary_amount_field">
                        ...
                        <input type="text" name="amount" id="amount" class="form-control"
                            placeholder="Pendapatan" value="{{ old('salary_amount') }}">
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3" id="name_field">
                        ...
                        <input type="text" name="name" id="name" class="form-control"
                            placeholder="Masukkan Nama Tunjangan" value="{{ old('name') }}">
                    </div>
...
<div class="modal fade" id="deductionModal" tabindex="-1" aria-labelledby="deductionModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <select name="bpjs_base_type" id="bulk_bpjs_base" class="form-control" data-bpjs-base
                                    data-context="bulk">
                                    <option value="">- Tidak Diubah -</option>
                                    <option value="amount_salary">Gaji Pokok (amount_salary)</option>
                                    <option value="salary_allowance">Gaji Pokok + Allowance Bulanan (salary_allowance)
                                    </option>
                                    <option value="base_budget">Base Budget (base_budget)</option>
                                </select>
                                <small class="text-muted">Pilih dasar penghitungan BPJS yang ingin diterapkan ke semua
                                    karyawan yang dipilih.</small>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="bpjs_type"
                                            value="normatif" data-bpjs-type data-context="bulk">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="bpjs_type"
                                            value="unnormatif" data-bpjs-type data-context="bulk">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="bpjs_type"
                                            id="bulk-bpjs-unchanged" value="" checked>
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="bulk_time_deductions[late]"
                                        id="bulk_time_deduction_late" class="form-control"
                                        placeholder="Masukkan jumlah potongan">
                                </div>
                                <div class="col-md-6">
                                    <label for="bulk_time_deduction_alpha">Potongan Alpha (Tidak Hadir)</label>
                                    <input type="text" name="bulk_time_deductions[alpha]"
                                        id="bulk_time_deduction_alpha" class="form-control"
                                        placeholder="Masukkan jumlah potongan">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="bulk_time_deductions[permit]"
                                        id="bulk_time_deduction_permit" class="form-control"
                                        placeholder="Masukkan jumlah potongan">
                                </div>
                                <div class="col-md-6">
                                    <label for="bulk_time_deduction_leave">Potongan Cuti (Leave)</label>
                                    <input type="text" name="bulk_time_deductions[leave]"
                                        id="bulk_time_deduction_leave" class="form-control"
                                        placeholder="Masukkan jumlah potongan">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select name="bulk_overtime[pay_type]" id="bulk_overtime_pay_type"
                                        class="form-control">
                                        <option value="">- Tidak Diubah -</option>
