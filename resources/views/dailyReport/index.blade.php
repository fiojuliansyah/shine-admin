        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                <div class="my-auto mb-2">
                    <h2 class="mb-1">Data Laporan Harian</h2>
                    <nav>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-2">
                                        <span
                                            class="avatar avatar-md rounded-circle bg-white d-flex align-items-center justify-content-center">
                                            <i class="ti ti-file-check text-primary fs-18"></i>
                                        </span>
                                    </div>
                                </div>
                                <div class="text-end">
                                    <p class="mb-1">Today's Incoming Report</p>
                                    <h4>{{ $todayCount }}</h4>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                        <form id="filter-form" method="GET" class="d-flex flex-wrap row-gap-3">
                            ...
                            <!-- Status Filter -->
                            <div class="dropdown me-3">
                                <select name="is_worked" class="form-select">
                                    <option value="">Status</option>
                                    <option value="worked"
                                        {{ isset($filters['is_worked']) && $filters['is_worked'] == 'worked' ? 'selected' : '' }}>
                                        Worked</option>
                                    <option value="not_worked"
                                        {{ isset($filters['is_worked']) && $filters['is_worked'] == 'not_worked' ? 'selected' : '' }}>
                                        Not Worked</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <a href="{{ route('dailyReport.index') }}" class="btn btn-outline-secondary">
                        ...
                        <div class="mb-2">
                            <a href="{{ route('dailyReport.export', request()->all()) }}" class="btn btn-outline-secondary">
                ...
                <div class="card-body p-0">
                    <div class="custom-datatable-filter table-responsive">
                        {{ $dataTable->table(['id' => 'reportdaily-table']) }}
                    </div>
                </div>
            </div>
            <!-- /reports list -->
