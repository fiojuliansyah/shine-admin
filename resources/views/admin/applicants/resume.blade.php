                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('applicants.update-status-single', $applicant->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Role User Saat Ini</label>
                                    <div class="text-muted">
                                        @if ($applicant->user)
                                            @foreach ($applicant->user->getRoleNames() as $roleName)
                                                <span class="badge bg-secondary">{{ $roleName }}</span>
                                            @endforeach
                                        @else
                                            <span class="text-danger small">User tidak ditemukan</span>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <p class="fw-bold">{{ $user->profile->birth_place ?? '-' }},
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <p class="fw-bold">{{ $user->profile->height ?? '-' }} cm /
                                        {{ $user->profile->weight ?? '-' }} kg</p>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <p class="fw-bold">{{ $user->profile->piercing == 'Present' ? 'Ada' : 'Tidak Ada' }}
                                    </p>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <h6 class="text-uppercase fw-bold text-primary">{{ $user->profile->gada_pratama }}
                                        </h6>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="text-muted small">Gada Madya</label>
                                        <h6 class="text-uppercase fw-bold text-primary">{{ $user->profile->gada_madya }}
                                        </h6>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="text-muted small">Gada Utama</label>
                                        <h6 class="text-uppercase fw-bold text-primary">{{ $user->profile->gada_utama }}
                                        </h6>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        @forelse($documents as $doc)
                                            <tr>
                                                <td>
                                                    <h6 class="fw-medium">{{ $doc->name }}</h6>
                                                </td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3" class="text-center p-4 text-muted">Tidak ada dokumen
                                                    yang diunggah.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
