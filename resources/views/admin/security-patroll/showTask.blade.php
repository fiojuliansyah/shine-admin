        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                <div class="my-auto mb-2">
                    <h2 class="mb-1">Security Patroll Task Planner</h2>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Security Patroll</li>
                            {{-- <li class="breadcrumb-item active" aria-current="page">{{ $site->name }}</li> --}}
                            <li class="breadcrumb-item" aria-current="page">Security Patroll Task Planner</li>
                        </ol>
                    </nav>
                </div>
            </div>
