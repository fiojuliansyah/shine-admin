    ...
    <div class="content">
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h2 class="mb-1">Edit Template E-Letter (Teks)</h2>
                <nav>
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                ...
                <button type="button" class="btn btn-primary mb-2" onclick="submitLetterForm()"><i class="ti ti-device-floppy me-1"></i>Update Template</button>
            </div>
        </div>
        ...
        <form id="letterForm" action="{{ route('letters.update', $letter->id) }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-lg-3">
                    @include('admin.letters.partials.text-sidebar')
                </div>

                <div class="col-lg-6">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <textarea id="letterEditor" name="editor_content">{!! $letter->description !!}</textarea>
                        </div>
                    </div>
                </div>

                <div class="col-lg-3">
                    @include('admin.letters.partials.text-variables')
                </div>
            </div>
        </form>
    </div>
...
@include('admin.letters.partials.text-custom-var-modal')
@endsection
...
<script>
    ...
    @if($letter->customVariables && $letter->customVariables->count())
        (function () {
            document.getElementById('customVarHeading').style.display = '';
