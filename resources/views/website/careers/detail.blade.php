                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <p class="text-muted mb-0"><i class="ti ti-map-pin me-1"></i> {{ $career->location }}</p>
                            </div>
                            <div class="text-end d-none d-md-block">
                                <h4 class="text-primary fw-bold mb-0">Rp {{ number_format($career->salary, 0, '.', ',') }}</h4>
                        ...
                        <div class="row g-3 pt-3 border-top">
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <span class="fw-semibold">{{ \Carbon\Carbon::parse($career->until_date)->format('d M Y') }}</span>
                            </div>
                            <div class="col-6 col-md-3">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm sticky-top" style="top: 20px; z-index: 10;">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted text-center small mb-4">Pastikan profil Anda sudah lengkap sebelum melamar untuk meningkatkan peluang diterima.</p>
                        
                        <form action="{{ route('web.applicants.career.apply', $career->slug) }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-primary w-100 py-2 fs-5 shadow-sm mb-3">
                        ...
                        <div class="alert alert-warning d-flex align-items-center mb-0" role="alert">
                            ...
                            <small>Batas waktu lamaran berakhir dalam {{ \Carbon\Carbon::parse($career->until_date)->diffForHumans() }}</small>
                        </div>
                    </div>
                </div>
