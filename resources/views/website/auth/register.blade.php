                                    ...
                                    <div class="">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="name" class="form-control border-end-0" placeholder="User Pelamar" value="{{ old('name') }}" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="email" name="email" class="form-control border-end-0" placeholder="pelamar@gmail.com" value="{{ old('email') }}" required>
                                                <span class="input-group-text border-start-0">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="phone" class="form-control border-end-0" placeholder="0812345678910" value="{{ old('phone') }}" required>
                                                <span class="input-group-text border-start-0">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center flex-wrap">
                                                <div class="text-center me-2 flex-fill">
                                                    <a href="javascript:void(0);" class="br-10 p-2 btn btn-outline-light border d-flex align-items-center justify-content-center">
                                                        <img class="img-fluid m-1" src="/admin/assets/img/icons/google-logo.svg" alt="Google">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title text-white" id="errorModalLabel">Terjadi Kesalahan</h5>
