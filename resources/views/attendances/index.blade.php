			...
			<div class="content">
				...
				<div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                        <h5>Data Absensi</h5>
                        <form id="attendance-filter-form" action="{{ route('attendances.index') }}" method="GET" class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                            <!-- Site Filter -->
                            <div class="me-3">
                            ...
                            <div class="dropdown me-3">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-3">
                                    <li>
                                        <a href="{{ route('attendances.index', array_merge(request()->except('type'), ['type' => ''])) }}" class="dropdown-item rounded-1">All</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('attendances.index', array_merge(request()->except('type'), ['type' => 'regular'])) }}" class="dropdown-item rounded-1">Regular</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('attendances.index', array_merge(request()->except('type'), ['type' => 'off'])) }}" class="dropdown-item rounded-1">OFF</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('attendances.index', array_merge(request()->except('type'), ['type' => 'late'])) }}" class="dropdown-item rounded-1">Terlambat</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('attendances.index', array_merge(request()->except('type'), ['type' => 'alpha'])) }}" class="dropdown-item rounded-1">Alpha</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('attendances.index', array_merge(request()->except('type'), ['type' => 'leave'])) }}" class="dropdown-item rounded-1">Cuti</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('attendances.index', array_merge(request()->except('type'), ['type' => 'permit'])) }}" class="dropdown-item rounded-1">Izin</a>
                                    </li>
                                </ul>
                            </div>
