                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2">
                                    <span class="avatar avatar-md rounded-circle bg-white d-flex align-items-center justify-content-center">
                                        <i class="ti ti-user-edit text-warning fs-18"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="text-end">
                                <p class="mb-1">Izin Terjadwal</p>
                                <h4>{{ $approvedCount }}</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2">
                                    <span class="avatar avatar-md rounded-circle bg-white d-flex align-items-center justify-content-center">
                                        <i class="ti ti-user-exclamation text-pink fs-18"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="text-end">
                    ...
                    <form id="filter-form" method="GET" class="d-flex flex-wrap row-gap-3">
                        ...
                        <div class="me-3">
                            <div class="input-icon-end position-relative">
                                <input type="date" name="date" class="form-control" value="{{ $filters['date'] ?? '' }}" placeholder="Tanggal">
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <a href="{{ route('permits.index') }}" class="btn btn-outline-secondary">
